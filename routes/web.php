...
Route::get('user/index', [UserController::class, 'index'])->name('index.user')->middleware('autorize_access');
Route::get('user/create', [UserController::class, 'create'])->name('create.user')->middleware('autorize_access');
Route::get('user/{user}', [UserController::class, 'show'])->name('show.user')->middleware('autorize_access');
Route::get('user/{user}/edit', [UserController::class, 'edit'])->name('edit.user')->middleware('autorize_access');
Route::put('user/{user}', [UserController::class, 'update'])->name('update.user')->middleware('autorize_access');
Route::delete('user/{user}', [UserController::class, 'destroy'])->name('delete.user')->middleware('autorize_access');
Route::post('user', [UserController::class, 'store'])->name('store.user')->middleware('autorize_access');
...
Route::put('update/post/{post}',[PostController::class, 'update'])->name('post.update')->middleware('autorize_access');
Route::post('store/post',[PostController::class, 'store'])->name('post.store')->middleware('autorize_access');
Route::delete('delete/post/{post}',[PostController::class, 'destroy'])->name('post.delete')->middleware('autorize_access');
Route::get('edit/post/{post}', [PostController::class, 'edit'])->name('post.edit')->middleware('autorize_access');
Route::get('show/post/{post}', [PostController::class, 'show'])->name('show.post')->middleware('autorize_access');
...
Route::put('partner/store',[PartnerController::class, 'store'])->name('partner.store')->middleware('autorize_access');
Route::get('partner/show/{partner}',[PartnerController::class, 'show'])->name('partner.show')->middleware('autorize_access');
Route::get('partner/edit/{partner}',[PartnerController::class, 'edit'])->name('partner.edit')->middleware('autorize_access');
Route::post('partner/update{partner}',[PartnerController::class, 'update'])->name('partner.update')->middleware('autorize_access');
Route::delete('partner/destroy/{partner}',[PartnerController::class, 'destroy'])->name('partner.destroy')->middleware('autorize_access');
